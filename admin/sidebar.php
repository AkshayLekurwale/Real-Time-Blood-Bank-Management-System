...
<div class="sidebar" ><b>
  ...
  <a href="blood_storage_details.php"   <?php if($active=='sotrage_details') echo "class='act'"; ?>><span class="glyphicon glyphicon-dashboard"></span>&nbsp&nbsp Blood storage</a>
  ...
  <a href="add_hospital.php"   <?php if($active=='add') echo "class='act'"; ?>><span class="glyphicon glyphicon-pencil"></span>&nbsp&nbspAdd Hospital</a>
  <a href="add_bloodbank.php"   <?php if($active=='add') echo "class='act'"; ?>><span class="glyphicon glyphicon-pencil"></span>&nbsp&nbspAdd Blood Bank</a>

  <a href="hospital_requests.php"   <?php if($active=='add') echo "class='act'"; ?>><span class="glyphicon glyphicon-pencil"></span>&nbsp&nbspHospital Requests</a>
